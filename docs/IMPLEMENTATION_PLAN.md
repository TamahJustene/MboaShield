...
Today: **15 July 2026** -> about 15 days to pitch; dossier due **22 July 15:30**
...
| Task | Done when |
|---|---|
| Personalise and submit `MboaShield.pdf` + form | Confirmation on ictinnovationweek.cm before 22 Jul 15:30 |
| Record 30s elevator video (optional but useful) | Link ready |
| List WhatsApp number for form | Form complete |

## Phase 1 - Demo spine (15-18 July) - IN PROGRESS
...
## Phase 3 - Polish and narrative (23-26 July)
| Task | Acceptance |
|---|---|
| Landing copy matches dossier story | Theme words visible |
| Architecture one-pager for jury if asked | 1 page |
| Rehearse pitch from `PITCH_3_MINUTES.md` x 10 | Timed <= 3:00 |

## Phase 4 - Bootcamp and final (27-30 July)
| Task | Acceptance |
|---|---|
