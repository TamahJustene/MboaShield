...
**Compliant intelligence (Phase 8):** Official APIs, licensed feeds, RSS, authorized/public interfaces only. No ToS-violating scraping.
...
| Phase | Version | Theme |
|---|---|---|
| 6 | 1.0.0 | Enterprise Identity |
| 7 | 1.1.0 | NTOC |
| 8 | 1.2.0 | Threat Intelligence |
| 9 | 1.3.0 | Evidence Vault |
